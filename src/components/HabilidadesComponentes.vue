<script setup>
import img1 from '/src/assets/icons/js.svg';
import img2 from '/src/assets/icons/python.svg';
import img3 from '/src/assets/icons/html-css.svg';
import img4 from '/src/assets/icons/java.svg';
import img5 from '/src/assets/icons/sql.svg';
import img6 from '/src/assets/icons/react.svg';
import img7 from '/src/assets/icons/vue.svg';
import img8 from '/src/assets/icons/node.svg';
import img9 from '/src/assets/icons/django.svg';
import img10 from '/src/assets/icons/bootstrap.svg';
import img11 from '/src/assets/icons/git.svg';
import img12 from '/src/assets/icons/docker.svg';
import img13 from '/src/assets/icons/cypress.svg';
import img14 from '/src/assets/icons/figma.svg';
import img15 from '/src/assets/icons/visual.svg';
import img16 from '/src/assets/icons/mongo.svg';
import img17 from '/src/assets/icons/mysql.svg';
import img18 from '/src/assets/icons/postgres.svg';
import img19 from '/src/assets/icons/arg.svg';
import img20 from '/src/assets/icons/eeuu.svg';
...
.skills-contenedor {
    ...
    /*Fondo con color solido    lo cambie */
    background-color: rgb(5, 99, 47);
}
