...
const educacion = ref([
  ...
  {fecha: '2023', title: "Certificación en Desarrollo Full Stack Platzi (2023)Finalicé un programa intensivo que cubrió el ciclo completo de desarrollo web, incluyendo tecnologías como React, Node.js, Express y MongoDB, con un enfoque en la creación de aplicaciones escalables y seguras."},
  {fecha: '2022', title: 'Curso de Arquitectura de Software Udemy (2022) Adquirí conocimientos sobre patrones de diseño, principios SOLID y arquitecturas de microservicios, aplicados a la creación de sistemas robustos y fáciles de mantener'},
  {fecha: '2021', title: 'Consultor en Ciberseguridad  SegurityFirst (2021-2022) Asesoré a empresas en la implementación de prácticas seguras de desarrollo y análisis de vulnerabilidades, reduciendo incidentes de seguridad en un 60%'},
